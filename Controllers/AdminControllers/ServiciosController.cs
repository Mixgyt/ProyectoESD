...
namespace Proyecto_Final_Estructura_De_Datos.Controllers.AdminControllers
{
    public class ServiciosController : Controller
    {
        ...
        public ServiciosController(DbHotelContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdServicio,Descripcion,NombreServicio,Precio")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdServicio,Descripcion,NombreServicio,Precio")] Servicio servicio)
        {
